...
4) If userbot joined enjoy music, If not add @CozmoHelper to your group and retry
* ✨For Channel Music Play✨ *
1) Make @TheCozmo_Bot admin of your channel 
...
4) Add @TheCozmo_Bot to the channel as an admin.
